...
topics = [
    ...
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_CONFIG_CHANGED_BY_USER", "channel": "debug"},
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_CONFIG_FAILED", "channel": "critical"},
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_CONFIGURED", "channel": "info"},
    ...
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_RESTART_BY_USER", "channel": "warning"},
    ...
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_DISCONNECTED", "channel": "warning"},
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_DISCONNECTED_LONG", "channel": "critical"},
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_UPGRADED", "channel": "info"},
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_UPGRADE_BY_SCHEDULE", "channel": "info"},
    ...
    {"topic": "device-events", "sub_topic": "access point", "name": "AP_RADAR_DETECTED", "channel": "warning"},
    ...
    {'topic': 'device-events', 'sub_topic': 'access point', 'name': 'AP_RADIUS_ACCOUNTING_SERVER_CHANGE', 'channel': 'info'},
    {'topic': 'device-events', 'sub_topic': 'access point', 'name': 'AP_RADIUS_AUTHENTICATION_SERVER_CHANGE', 'channel': 'info'},
    {'topic': 'device-events', 'sub_topic': 'access point', 'name': 'AP_RADSEC_FAILURE', 'channel': 'critical'},
    {'topic': 'device-events', 'sub_topic': 'access point', 'name': 'AP_RADSEC_SERVER_CHANGE', 'channel': 'info'},
    {'topic': 'device-events', 'sub_topic': 'access point', 'name': 'AP_RADSEC_RECOVERY', 'channel': 'info'},
    ...
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_CONFIG_CHANGED_BY_USER", "channel": "debug"},
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_RECONFIGURED", "channel": "debug"},
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_CONFIGURED", "channel": "info"},
    ...
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_VPN_PATH_DOWN", "channel": "warning"},
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_VPN_PATH_UP", "channel": "info"},
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_VPN_PEER_UP", "channel": "info"},
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_VPN_PEER_DOWN", "channel": "warning"},
    ...
    {"topic": "device-events", "sub_topic": "wan edge", "name": "GW_DHCP_RESOLVED", "channel": "info"},
    ...
    {'topic': 'device-events', 'sub_topic': 'wan edge', 'name': 'GW_RESTART_BY_USER', 'channel': 'info'},
    {'topic': 'device-events', 'sub_topic': 'wan edge', 'name': 'GW_ALARM_POE_CONTROLLER_UPGRADE_AVAILABLE', 'channel': 'debug'},
    {'topic': 'device-events', 'sub_topic': 'wan edge', 'name': 'GW_PORT_RG_ST_CHANGED', 'channel': 'debug'},
    {'topic': 'device-events', 'sub_topic': 'wan edge', 'name': 'GW_UPGRADE_BY_MIST', 'channel': 'debug'},
    ...
    {"topic": "device-events", "sub_topic": "switch", "name": "SW_CONFIG_CHANGED_BY_USER", "channel": "debug"},
    {"topic": "device-events", "sub_topic": "switch", "name": "SW_RECONFIGURED", "channel": "debug"},
    {"topic": "device-events", "sub_topic": "switch", "name": "SW_CONFIGURED", "channel": "info"},
    ...
    {"topic": "device-events", "sub_topic": "switch", "name": "SW_DISCONNECTED", "channel": "warning"},
    ...
    {'topic': 'device-events', 'sub_topic': 'switch', 'name': 'SW_ALARM_POE_CONTROLLER_UPGRADE_AVAILABLE', 'channel': 'debug'},
    ...
    {'topic': 'mxedge-events', 'sub_topic': 'config', 'name': 'ME_CONFIGURED', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'connectivity', 'name': 'ME_CONNECTED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'connectivity', 'name': 'ME_DISCONNECTED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'system', 'name': 'ME_RESTART_BY_USER', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'package', 'name': 'ME_PACKAGE_INSTALL_FAILED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'package', 'name': 'ME_PACKAGE_UNINSTALLED', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'package', 'name': 'ME_PACKAGE_UNINSTALL_FAILED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'package', 'name': 'ME_PACKAGE_UPDATED', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'package', 'name': 'ME_PACKAGE_UPDATE_FAILED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'system', 'name': 'ME_SERVICE_CRASHED', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORTS_BOUNCE_BY_USER', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORTS_BOUNCED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORTS_BOUNCE_FAILED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_AP_DISCONNECT_BY_USER', 'channel': 'debug'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_AP_DISCONNECTED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_AP_DISCONNECT_FAILED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_FAN_PLUGGED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_FAN_UNPLUGGED', 'channel': 'critical'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_PSU_PLUGGED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_PSU_UNPLUGGED', 'channel': 'critical'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_POWERINPUT_CONNECTED', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'hardware', 'name': 'ME_POWERINPUT_DISCONNECTED', 'channel': 'critical'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_BLOCKED', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_RECOVERY', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_LINK_DOWN', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_LINK_RECOVERY', 'channel': 'info'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_DROPPED_FROM_LACP', 'channel': 'warning'},
    {'topic': 'mxedge-events', 'sub_topic': 'tunterm', 'name': 'TT_PORT_JOINED_LACP', 'channel': 'debug'}
]